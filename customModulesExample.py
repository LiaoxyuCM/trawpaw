from trawpaw import Trawpaw, TrawpawDatatypes, TrawpawHandleModuleResult, TrawpawFunction
...
@executor.registerCustomModule(name="print", 
...
@executor.registerCustomModule(name="string.addto",
                               avaliableDatatypes=TrawpawDatatypes.String,
...
@executor.registerCustomModule(name="string.inserttofirst",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.length",
                               avaliableDatatypes=TrawpawDatatypes.String, 
...
@executor.registerCustomModule(name="string.reverse",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.toupper",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.tolower",
                              avaliableDatatypes=TrawpawDatatypes.String,
                              handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.encodeuri",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.decodeuri",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.escape",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.unescape",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="hash.md5",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="hash.sha1",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="hash.sha224",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="hash.sha256",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="hash.sha384",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="base64.encode",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="base64.decode",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.offset.forward",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
...
@executor.registerCustomModule(name="string.offset.backward",
                               avaliableDatatypes=TrawpawDatatypes.String,
                               handleResult=TrawpawHandleModuleResult.assignToVar)
